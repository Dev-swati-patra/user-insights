...
public enum ServiceCode {
	...
	SVC007("SVC007",
			"User Password must be contain one uppercase letter/n one lowercase letter/n one digit/n one special character/n minimum eight character."),
...
//	SVC026("SVC026", "Either user name or user email is required."),
	...
	SVC030("SVC030", "Spot name must be required."),
	SVC031("SVC031", "Spot name does not exist."),
	SVC032("SVC032", "City name must not be null or empty."),
